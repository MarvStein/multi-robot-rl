"""Reach-dense task benchmark: train across robot/goal configurations with PBRS reward.

Run from repo root:
    uv run python scripts/benchmark_reach_dense.py
"""
...
class ReachDenseBenchmark(BenchmarkRunner):
    """Benchmark runner for the reach-dense task."""

    task_name = "reach-dense"
    ...
    def _variant_label(self, algo_name: str, variant: dict) -> str:
        ...
        as a directory/experiment name.  Example outputs:
        ``"ppo_2mp_5goals_dense_reward"``, ``"ppo_1ur10_5goals_dense_reward"``.
        ...
        Returns:
            ...
            goal count, and ``_dense_reward`` suffix.
        """
        parts = [algo_name]
        ...
        parts.append("dense_reward")
        return "_".join(parts)


if __name__ == "__main__":
    ReachDenseBenchmark().run(ALGORITHMS, VARIANTS, TIMEOUT_S, SEEDS)
